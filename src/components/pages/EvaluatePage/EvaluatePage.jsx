...
export default function EvaluatePage(props) {
  ...
  return (
    <Container>
      ...
      <Question>
        <QuestionTitle>
          Quão fácil é tornar a ideia conhecida pelo público alvo? Ela pode ser
          facilmente viralizada?
        </QuestionTitle>
        <QuestionRadio
          onChange={(e) => {
      ...
      <Question>
        <QuestionTitle>
          Quais possíveis parcerias para desenvolvimento da solução tecnológica
          e conteúdo quantitativo e qualitativo?
        </QuestionTitle>
        <QuestionRadio
          onChange={(e) => {
      ...
      <Question>
        <QuestionTitle>
          O quão fácil é simplificar o projeto, de modo que ele consuma o mínimo
          possível, maximizando a taxa de lucro?
        </QuestionTitle>
        <QuestionRadio
          onChange={(e) => {
      ...
      <Question>
        <QuestionTitle>
          Quais políticas municipais, estaduais e nacionais de incentivo a área
          de conhecimento da tecnologia? Quais incentivos para desenvolvimento
          da tecnologia?
        </QuestionTitle>
        <QuestionRadio
          onChange={(e) => {
      ...
      <Question>
        <QuestionTitle>
          Se a solução proposta tem viabilidade financeira. Quais investimentos
          financeiro, tempo e RH são viáveis?
        </QuestionTitle>
        <QuestionRadio
          onChange={(e) => {
